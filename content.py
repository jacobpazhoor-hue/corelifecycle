...
recurring fixer THE LICENCIADO (the cartel's lawyer/launderer — the shared-universe character who gets
a late dialogue line and is left UNRESOLVED). MIDPOINT (t14): the patrón above you brands El Tío an
informant and orders you to kill him to prove loyalty; you do it, and press his medallion into his
...
samurai flash-forward seppuku): cold open is AFTERMATH (the morning it ends); act-2 shape is a true
RISE-THEN-FALL (you actually lose it all); ending is cyclical (medallion to a new kid) with one door
left open (the demand up north / the Licenciado).
"""
...
SCENES = [
    ...
    dict(id="t04", level="LEVEL 02  ·  EL BURRERO  (THE MULE)", template="sierraRoute",
         narration=("Sixteen now, and watching the road isn't enough — El Tío puts you on it. You ride the "
                    "sierra in the back of a pickup that smells of diesel and cut lime, moving packages you're "
                    "told never to open. Before every run you kiss the little saint. Five thousand a load. "
                    "The mountains are beautiful at dawn and full of shallow graves, and you learn to tell "
                    "yourself the second part doesn't apply to you. The weight in the truck bed is the first "
                    "thing you've carried that can end you."),
    ...
    dict(id="t08", level=None, template="narcoShrineRite",
         narration=("After, you go back to the shrine, because there's nowhere else the shaking stops. You "
                    ...
                    "are eighteen, nineteen, already flinching at engines. A sicario in this town gets maybe "
                    "three years before the road collects him. Nobody plans past that. Planning is for people "
                    "with a way out."),
    ...
    dict(id="t11", level=None, template="plazaTown",
         narration=("You run the town the way the cartel taught you: not with fear alone, but with a floor. El "
                    "piso — the tax on the ground itself. The taquero pays. The pharmacy pays. The bus line, "
                    "the avocado grower, the migrant paying to cross your stretch of desert — all of it flows "
                    "up through you. Forty million a year moves through your hands. Almost none of it stays "
                    "there; you pay up, and you pay the police, and you pay the soldiers who wave your trucks "
                    "through. The whole town works for you, and you work for the men above you."),
    ...
    dict(id="t15", level="LEVEL 05  ·  EL LUGARTENIENTE  (THE LIEUTENANT)", template="warRoom",
         narration=("You should have died of it. Instead the grief hardens into something colder, and the "
                    ...
                    "plaza, you run the war across a dozen. Rival cartels, the army, a map of the state stuck "
                    "with pins that used to be people. Three hundred million moves under you. You stop reading "
                    "the count as names. You read it as a column, and the column is the only thing you keep "
                    "clean."),
         overlay=dict(big="$300M", sub="THE DEAD STOP BEING PEOPLE · THEY BECOME A COLUMN")),
    dict(id="t16", level=None, template="countRoom",
         narration=("The money isn't a metaphor up here; it's a physical problem. A room, a naked bulb, tables "
                    "stacked with banded cash the counters can't finish before more arrives — a wall of it, "
                    "sour and papery in the heat. Money buys the police. Money buys the judge. Money buys the "
                    "corrido singers who make you a legend and the mothers who won't testify. Money buys "
                    "everything in this country except the one thing you spend it all chasing: a door out. "
                    "That one isn't for sale to men like you."),
    ...
    dict(id="t18", level="LEVEL 06  ·  EL PATRÓN  (THE KINGPIN)", template="ranchCompound", gap=0.7,
         narration=("The patrón above you is killed in his own bed, and there is no ceremony to what comes "
                    "next — you're simply the one still standing, so the cartel is yours. El Patrón. The "
                    "kingpin. A fortress in the mountains with a tunnel under the bedroom floor, an army, a "
                    "private zoo, generals and governors on the payroll. Forbes could put a number on you now "
                    "— a billion dollars — and print it beside your face. Every police force on two continents "
                    "knows your name. You have become the man the whole climb was built to reach."),
    ...
    dict(id="t19", level=None, template="jet",
         narration=("Reach is the drug now, not money. A private strip carved into the sierra, planes that "
                    ...
                    "product moves through ports you've never seen, in countries you couldn't find on a map, "
                    "into the noses of people who will never once think of the dust town or the alley or the "
                    "eighty-five dollars. You point a finger and cargo crosses an ocean. But you sleep in a "
                    "different room every night, and the tunnel is always within ten steps."),
         overlay=None),
    dict(id="t20", level=None, template="window",
         narration=("They write ballads about you. Real ones, on the radio, corridos that make the alley "
                    "sound like a coronation and leave out the smell. Boys in dust towns wear your saint and "
                    "want your life, exactly the way you once wanted the man's on the corner. From your window "
                    "you can see three states you control and not one street you can walk down. They sing your "
                    "name, and can't say it near a soldier. They know your face, and you can't show it in "
                    "daylight. You own the corridor, and you live in a tunnel."),
    ...
    dict(id="t21", level="LEVEL 07  ·  LA RED  (THE NETWORK)", template="warRoom",
         narration=("But you are not the top, and the proof is that the machine doesn't need you. La red — the "
                    ...
                    "twitch for a single day. You spent your life believing you were climbing toward the "
                    "center. There is no center. There is a market, and it wears men like you the way you "
                    "wore that plastic saint — until they crack, then it picks up another."),
    ...
    dict(id="t22", level=None, template="wiretap",
         narration=("Somewhere in a cool northern office, men you'll never meet are listening. A reel turns. A "
                    "wall of photographs has your face in the center now, red string running out from it to "
                    "every man you ever trusted. The Americans don't need to beat you. They need to buy one "
                    "person close enough, and in a life built entirely on plata o plomo, everyone has already "
                    "learned the lesson that everyone can be bought. Including the men who guard your bedroom "
                    "door."),
         overlay=None),
    dict(id="t23", level=None, template="dinner",
         narration=("The Licenciado comes to see you — the cartel's lawyer, the one who launders the cash "
                    "through the port and the pharmacy and the football club, who has served three patrones "
                    "and buried none of them. He never carries a gun. He carries a pen, which is worse. He "
                    "lays out your accounts and your options, and there are fewer of the second than the "
                    "first, and he tells you the thing you already knew the morning the dogs went quiet."),
         overlay=None,
